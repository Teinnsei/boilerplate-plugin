...
class ImmutableGenerateEqualsHandler extends GenerateEqualsHandler {

    private static final PsiElementClassMember[] DUMMY_RESULT = new PsiElementClassMember[1];

    private static final Logger LOG = Logger.getInstance(ImmutableGenerateEqualsHandler.class);
